#
#  Be sure to run `pod spec lint PGWKWebView.podspec' to ensure this is a
...
DESC
  ...
  s.author             = { "xukai" => "purepgmr@163.com" }
  # Or just: s.author    = "xukai"
  # s.authors            = { "xukai" => "purepgmr@163.com" }
  # s.social_media_url   = "http://twitter.com/xukai"
  ...
  s.source_files  = "PGWKWebView/Classes/**/*.{h,m}"
  s.exclude_files = "Classes/Exclude"

  # s.public_header_files = "Classes/**/*.h"
  s.vendored_frameworks = ['PGWKWebView/Libs/AlipaySDK.framework', 'PGWKWebView/Libs/iflyMSC.framework']
